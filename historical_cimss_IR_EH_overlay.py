...
while startd <= endd:
	...
	for hh in subt:
		...
		os.system("convert ./Indian/"+strd_str+"/IRImageNHCEnhancement/"+strd_str+"."+hh+".Indian.IRImageNHCEnhancement.png \
				...
				convert ./Australia/"+strd_str+"/IRImageNHCEnhancementWest/"+strd_str+"."+hh+".Australia.IRImageNHCEnhancementWest.png \
					-crop 868x680+260+0 \
					./processing_his_cimss/cropped_wau_"+strd_str+"."+hh+".GIF ;\
				convert ./NWPacific/"+strd_str+"/IRImageNHCEnhancement/"+strd_str+"."+hh+".NWPacific.IRImageNHCEnhancement.png \
					-crop 1080x644+0+0 \
		...
		os.system("convert -size 1965x1242 xc:black ./processing_his_cimss/bk_"+strd_str+"."+hh+".png ;\
				convert -composite -geometry +0+277.1 ./processing_his_cimss/bk_"+strd_str+"."+hh+".png \
					./processing_his_cimss/cropped_io_"+strd_str+"."+hh+".GIF ./processing_his_cimss/out1_"+strd_str+"."+hh+".png ;\
				convert -composite -geometry +872+555.1 ./processing_his_cimss/out1_"+strd_str+"."+hh+".png \
					./processing_his_cimss/cropped_wau_"+strd_str+"."+hh+".GIF ./processing_his_cimss/out2_"+strd_str+"."+hh+".png ;\
				convert -composite -geometry +889+0 ./processing_his_cimss/out2_"+strd_str+"."+hh+".png \
