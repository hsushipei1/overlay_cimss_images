...
os.system("convert ./processing_rt_cimss/io.GIF -crop 1080x666+0+0 ./processing_rt_cimss/io2.GIF ;\
		convert ./processing_rt_cimss/wau.GIF -crop 868x680+260+0 ./processing_rt_cimss/wau2.GIF ;\
		convert ./processing_rt_cimss/wnp.GIF -crop 1080x644+0+0 ./processing_rt_cimss/wnp2.GIF")

# Overlay images
os.system("convert -size 1965x1242 xc:black ./processing_rt_cimss/bk.png ;\
		convert -composite -geometry +0+277.1 ./processing_rt_cimss/bk.png ./processing_rt_cimss/io2.GIF ./processing_rt_cimss/out.png ;\
		convert -composite -geometry +872+555.1 ./processing_rt_cimss/out.png ./processing_rt_cimss/wau2.GIF ./processing_rt_cimss/out2.png ;\
		convert -composite -geometry +889+0 ./processing_rt_cimss/out2.png ./processing_rt_cimss/wnp2.GIF ./overlaid_cimss_IR_latest.png")
